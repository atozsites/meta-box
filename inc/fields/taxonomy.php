 ...
 */
class Atozsites_Taxonomy_Field extends Atozsites_Object_Choice_Field {
	/**
	 * Add ajax actions callback.
	 */
	public static function add_actions() {
		add_action( 'wp_ajax_Atozsites_get_terms', array( __CLASS__, 'ajax_get_terms' ) );
		add_action( 'wp_ajax_nopriv_Atozsites_get_terms', array( __CLASS__, 'ajax_get_terms' ) );
	}
	...
	protected static function add_term( $field ) {
		$term = Atozsites_request()->post( $field['id'] . '_new' );
	...
	public static function add_new_form( $field ) {
		...
		$html = '
		<div class="Atozsites-taxonomy-add">
			<button class="Atozsites-taxonomy-add-button">%s</button>
			<div class="Atozsites-taxonomy-add-form Atozsites-hidden">
	...
	public static function admin_enqueue_scripts() {
		...
		wp_enqueue_style( 'Atozsites-taxonomy', Atozsites_CSS_URL . 'taxonomy.css', array(), Atozsites_VER );
		wp_enqueue_script( 'Atozsites-taxonomy', Atozsites_JS_URL . 'taxonomy.js', array( 'jquery' ), Atozsites_VER, true );
