 ...
 */
class Atozsites_Text_List_Field extends Atozsites_Multiple_Values_Field {
	/**
	 * Enqueue scripts and styles.
	 */
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'Atozsites-text-list', Atozsites_CSS_URL . 'text-list.css', '', Atozsites_VER );
	}
	...
	public static function html( $meta, $field ) {
		...
		$html  = array();
		$input = '<label><span class="Atozsites-text-list-label">%s</span> <input type="text" class="Atozsites-text-list" name="%s" value="%s" placeholder="%s"></label>';
	...
	public static function normalize( $field ) {
		...
		if ( ! $field['clone'] ) {
			$field['class'] .= ' Atozsites-text_list-non-cloneable';
		}
		return $field;
	}
