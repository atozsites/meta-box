 ...
 * Fieldset text class.
 */
class Atozsites_Fieldset_Text_Field extends Atozsites_Text_Field {
	/**
	 * Enqueue field scripts and styles.
	 */
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'Atozsites-fieldset-text', Atozsites_CSS_URL . 'fieldset-text.css', '', Atozsites_VER );
	}
