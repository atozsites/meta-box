 ...
 * Post field class.
 */
class Atozsites_Post_Field extends Atozsites_Object_Choice_Field {
	/**
	 * Add ajax actions callback.
	 */
	public static function add_actions() {
		add_action( 'wp_ajax_Atozsites_get_posts', array( __CLASS__, 'ajax_get_posts' ) );
		add_action( 'wp_ajax_nopriv_Atozsites_get_posts', array( __CLASS__, 'ajax_get_posts' ) );
	}
