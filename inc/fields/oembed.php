 ...
 * OEmbed field class.
 */
class Atozsites_OEmbed_Field extends Atozsites_Text_Field {
	/**
	...
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'Atozsites-oembed', Atozsites_CSS_URL . 'oembed.css', '', Atozsites_VER );
		wp_enqueue_script( 'Atozsites-oembed', Atozsites_JS_URL . 'oembed.js', array( 'jquery', 'underscore' ), Atozsites_VER, true );
	}
	...
	public static function add_actions() {
		add_action( 'wp_ajax_Atozsites_get_embed', array( __CLASS__, 'wp_ajax_get_embed' ) );
	}
	...
	public static function get_embed( $url, $not_available = '' ) {
		...
		if ( $not_available ) {
			$not_available = '<div class="Atozsites-oembed-not-available">' . wp_kses_post( $not_available ) . '</div>';
		}
		$not_available = apply_filters( 'Atozsites_oembed_not_available_string', $not_available );
	...
	public static function html( $meta, $field ) {
		return parent::html( $meta, $field ) . sprintf(
			...
			<div class="Atozsites-embed-media">%s</div>',
