 ...
 */
class Atozsites_Taxonomy_Advanced_Field extends Atozsites_Taxonomy_Field {
	/**
	...
	public static function save( $new, $old, $post_id, $field ) {
		...
		Atozsites_Field::save( $new, $old, $post_id, $field );
	}
	...
	public static function raw_meta( $object_id, $field, $args = array() ) {
		$args['single'] = true;
		$meta           = Atozsites_Field::raw_meta( $object_id, $field, $args );
