 ...
 */
class Atozsites_Image_Field extends Atozsites_File_Field {
	/**
	...
	public static function admin_enqueue_scripts() {
		...
		wp_enqueue_media();
		wp_enqueue_style( 'Atozsites-image', Atozsites_CSS_URL . 'image.css', array(), Atozsites_VER );
	}
	...
	protected static function file_html( $file, $index, $field ) {
		...
		if ( $edit_link ) {
			$edit_link = sprintf( '<a href="%s" class="Atozsites-image-edit" target="_blank"><span class="dashicons dashicons-edit"></span></a>', $edit_link );
		}

		return sprintf(
			'<li class="Atozsites-image-item attachment %s">
				...
				<div class="Atozsites-image-actions">
					%s
					<a href="#" class="Atozsites-image-delete Atozsites-file-delete" data-attachment_id="%s"><span class="dashicons dashicons-no-alt"></span></a>
				</div>
			</li>',
