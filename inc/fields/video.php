 ...
 */
class Atozsites_Video_Field extends Atozsites_Media_Field {
	/**
	 * Enqueue scripts and styles.
	 */
	public static function admin_enqueue_scripts() {
		parent::admin_enqueue_scripts();
		wp_enqueue_style( 'Atozsites-video', Atozsites_CSS_URL . 'video.css', array( 'Atozsites-media' ), Atozsites_VER );
		wp_enqueue_script( 'Atozsites-video', Atozsites_JS_URL . 'video.js', array( 'Atozsites-media' ), Atozsites_VER, true );
	...
	public static function print_templates() {
		...
		require_once Atozsites_INC_DIR . 'templates/video.php';
	}
}
