 ...
 * User field class.
 */
class Atozsites_User_Field extends Atozsites_Object_Choice_Field {
	/**
	 * Add actions.
	 */
	public static function add_actions() {
		add_action( 'wp_ajax_Atozsites_get_users', array( __CLASS__, 'ajax_get_users' ) );
		add_action( 'wp_ajax_nopriv_Atozsites_get_users', array( __CLASS__, 'ajax_get_users' ) );
