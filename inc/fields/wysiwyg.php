 ...
 */
class Atozsites_Wysiwyg_Field extends Atozsites_Field {
	/**
	...
	public static function admin_enqueue_scripts() {
		wp_enqueue_editor();
		wp_enqueue_style( 'Atozsites-wysiwyg', Atozsites_CSS_URL . 'wysiwyg.css', array(), Atozsites_VER );
		wp_enqueue_script( 'Atozsites-wysiwyg', Atozsites_JS_URL . 'wysiwyg.js', array( 'jquery' ), Atozsites_VER, true );
	}
