 ...
 * @package Meta Box
 */
class Atozsites_Core {
	/**
	 * Initialization.
	 */
	public function init() {
		load_plugin_textdomain( 'meta-box', false, plugin_basename( Atozsites_DIR ) . '/languages/' );
	...
	public function register_meta_boxes() {
		$configs  = apply_filters( 'Atozsites_meta_boxes', array() );
		$registry = Atozsites_get_registry( 'meta_box' );
